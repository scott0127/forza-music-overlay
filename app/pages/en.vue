...
const supportDrinks = [
  { icon: '☕', name: 'coffee', note: 'For checking fixes off the list' },
  { icon: '🧋', name: 'bubble tea', note: 'For the longer debugging sessions' },
  { icon: '🍵', name: 'matcha latte', note: 'For shaping the next feature' },
  { icon: '🥤', name: 'sparkling drink', note: 'For adding fizz to new ideas' }
];
      ...
      <div class="wrap grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center w-full z-10">
        <div class="motion-hero-copy">
          ...
          <div class="motion-hero-badges flex items-center gap-2 flex-wrap mb-4">
            ...
            <span class="bg-slate-900 border border-slate-800 text-cyan-400 font-extrabold text-[10px] tracking-widest px-2.5 py-1 rounded">v3.1.1</span>
          ...
          <div class="motion-hero-actions grid grid-cols-1 sm:grid-cols-[1.3fr_1fr] gap-3.5 mt-8 max-w-xl">
            ...
            >
              ...
              <div>
                <span class="block font-black text-sm md:text-base leading-none">Download v3.1.1</span>
    ...
    <section class="desktop-release hidden lg:block" id="sponsor">
      <div class="wrap desktop-release-grid">
        <div class="sponsor sponsor-story">
          ...
          <div class="sponsor-story-footer">
            ...
            <div class="sponsor-actions">
              ...
              <a class="sponsor-button" href="https://buymeacoffee.com/scott5497" target="_blank" rel="noopener noreferrer">Buy me a {{ supportDrink.name }}</a>
            </div>
          </div>
        </div>
        ...
        <aside class="download-panel" id="snapshot">
          ...
          <div class="meta-row"><span>File</span><strong>ForzaMusicOverlay-release3.1.0_final.zip</strong></div>
          <div class="meta-row"><span>Platform</span><strong>Windows 10 / 11</strong></div>
          <div class="meta-row"><span>Updated</span><strong>2026-06-01</strong></div>

          <div class="snapshot-box">
            <p class="box-label">Version Snapshot</p>
            <p>3.1.1 improves packaging to reduce Windows Defender false positives.</p>
          ...
          <div class="download-box">
            ...
            >
              ...
              ForzaMusicOverlay-release3.1.0_final.zip
            </a>
          </div>
        </aside>
      </div>
                  ...
                  <div class="demo-panel mt-4 p-3 bg-slate-950 text-white rounded-lg border border-slate-800 text-xs">
                    ...
                    <div class="demo-file flex items-center gap-2 mt-2 bg-slate-900 p-2 rounded">
                      ...
                      <div class="truncate text-slate-300">
                        <strong class="block text-xs truncate">ForzaMusicOverlay-release3.1.0_final.zip</strong>
    ...
    <section class="updates bg-slate-950 py-16" id="updates">
      <div class="wrap">
        <div class="updates-head flex items-end justify-between mb-8">
          ...
          <span class="text-slate-400 text-sm">Latest version: v3.1.1</span>
        </div>
        ...
        <div class="update-list border-t border-b border-slate-800">
          ...
          <article class="update grid grid-cols-[180px_1fr] gap-6 py-7 hover:bg-slate-900/10 hover:translate-x-1 transition-all duration-200">
            <div>
              <p class="update-version text-cyan-300 font-black text-sm">v3.1.1</p>
            ...
            <div>
              ...
              <div class="entry-actions flex items-center gap-3 flex-wrap mt-3">
                ...
                <p class="entry-file text-slate-500 text-sm">ForzaMusicOverlay-release3.1.0_final.zip · 43.1 MB</p>
              </div>
